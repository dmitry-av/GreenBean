    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(choices=[('album', 'album'), ('artist', 'artist'), ('track', 'track')], max_length=24)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disc_id', models.SlugField(max_length=255, unique=True)),
                ('cover', models.ImageField(blank=True, null=True, upload_to='band_covers')),
                ('cover_ext_url', models.TextField(blank=True, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('is_full_record', models.BooleanField(default=False)),
                ('albums_found', models.BooleanField(default=False)),
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('favorite', models.ManyToManyField(blank=True, related_name='artist_favorite', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['name'],
            },
